...
var (
	...
	// DefaultJavaScriptEnabled is the global value for the AttributeJavaScriptEnabled attribute.
	DefaultJavaScriptEnabled = false
...
func NewBrowser() *browser.Browser {
	...
	bow.SetAttributes(browser.AttributeMap{
		...
		browser.JavaScriptEnabled:   DefaultJavaScriptEnabled,
	})
