...
func TestImages(t *testing.T) {
	...
	imageServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if strings.Contains(r.URL.Path, "HW4bJtY.jpg") || strings.Contains(r.URL.Path, "Cxagv.jpg") {
	...
	// Replace image URLs in the HTML with the test server URLs
	testHTML := strings.Replace(htmlPage1,
		"http://i.imgur.com/HW4bJtY.jpg",
		imageServer.URL+"/HW4bJtY.jpg", -1)
	...
	ut.AssertEquals(imageServer.URL+"/HW4bJtY.jpg", images[0].URL.String())
